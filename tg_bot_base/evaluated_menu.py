...
class EvaluatedMenuPhoto(EvaluatedMenu):
    ...
    def __eq__(self, other: "EvaluatedMenu"):
        ...
        if isinstance(self.photo.media, InputFile) and \
            isinstance(other.photo.media, InputFile):
            return self.photo.media.input_file_content == \
                other.photo.media.input_file_content
